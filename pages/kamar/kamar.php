  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="addLabel">Tambah Data Kamar</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <div class="card">
          <div class="card-body">
            <form action="./controllers/kamarController.php" method="POST">
              <input type="hidden" name="nama" value="<?= $_SESSION['nama'] ?>">
              <input type="hidden" name="user_id" value="<?= $_SESSION['user_id'] ?>">

              <div class="form-group row">
                <label for="kamar" class="col-sm-4 col-form-label">Nama kamar</label>
                <div class="col-sm-8">
                  <input type="text" class="form-control" name="nama_kamar" placeholder="Masukan nama kamar">
                </div>
              </div>

              <div class="form-group row">
                <label for="kamar" class="col-sm-4 col-form-label">Nama Asrama</label>
                <div class="col-sm-8">
              ...
              <div class="form-group row">
                <label for="kamar" class="col-sm-4 col-form-label">Keterangan</label>
                <div class="col-sm-8">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <select class="form-select" name="id_asrama">
                      ...
                      <?php foreach (get_asrama() as $asrama): ?>
                        <option value="<?= $asrama['id_asrama'] ?>" <?= $asrama['id_asrama'] == $data['id_asrama'] ? 'selected' : '' ?>>
                          <?= $asrama['nama_asrama'] ?>
                        </option>
                      <?php endforeach; ?>
                    </select>
